...
class MuseumItem(Base):
    ...
    fond_id: Mapped[int | None] = mapped_column(ForeignKey("fonds.id"), nullable=True)
    fond_number: Mapped[str | None] = mapped_column(String(100), nullable=True, index=True)
    ...
    storage_place_id: Mapped[int | None] = mapped_column(ForeignKey("storage_places.id"), nullable=True)
